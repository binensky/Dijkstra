...
#define THRESHOLD_RED_CR 170
#define THRESHOLD_YELLOW_CB 130
#define THRESHOLD_YELLOW_CR 130
#define THRESHOLD_GREEN_CB 130
...
#define IS_TRAFFIC_RED(X,Z) (  CR(X,Z) >= THRESHOLD_RED_CR)
#define IS_TRAFFIC_YELLOW(X,Z) ( CB(X,Z) < THRESHOLD_CB && CR(X,Z) >= THRESHOLD_YELLOW_CR && CR(X,Z) < THRESHOLD_RED_CR)
#define IS_TRAFFIC_GREEN(X,Z) (  CR(X,Z) < THRESHOLD_GREEN_CR)
